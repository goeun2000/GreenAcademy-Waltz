...
<%--       <form name="readForm" action = "/contest/contestBoardUpdate" role="form" method="get">
	...
	<%-- <div style="margin-top:100px;">
            ...
            <p><c:out value="${detail.PO_CONTENT }"/></p>
	  ...
	  <%-- <c:if test="${authInfo.id ne null}">
            <form action="/contest/commentBoardInsert" method="post" name="commentForm">
               <h3>댓글 작성</h3>
               <input type="hidden" name="BO_NUM" value=<c:out value="4"/>> 
               <input type="hidden" name="PO_NUM" id="PO_NUM"  value=<c:out value="${detail.PO_NUM}"/>> 
               <input type="hidden" name="page" value=<c:out value="${scri.page}"/>>
               <input type="hidden" name="perPageNum" value=<c:out value="${scri.perPageNum}"/>>
               <input type="hidden" name="searchType" value=<c:out value="${scri.searchType}"/>>
               <input type="hidden" name="keyword" value=<c:out value="${scri.keyword}" />>
                  ...
                  <div id="cohead${commentList.CO_NUM}">   
                     <div id="abt${commentList.CO_NUM}">
                        <c:if test="${(authInfo.id eq commentList.MEM_ID) || (authInfo.manager eq 1)}">
                           ...
                           <a class="disableLink" href="<c:url value='/contest/commentBoardDelete?PO_NUM=${detail.PO_NUM}&CO_NUM=${commentList.CO_NUM}&page=${scri.page}&perPageNum=${scri.perPageNum}&searchType=${scri.searchType}&keyword=${scri.keyword}'/>" role="button" onclick="checkDelete()">삭제</a>
                        </c:if>
